<?php
	...
	<html>
		<head>
			<title>Внимание! Магазин тестовый для оценки качества работы! Товар не продается! Заявка на комплектующие для сборки патронов</title>
			<style>
		     td, th{
		...
		<body>
			<h2>Заказ</h2>
            <p>
		Внимание! Магазин тестовый для оценки качества работы! Товар не продается!
		Здравствуйте, от Вас поступила заявка на приобретение следующих комплектующих для снаряжения патронов:</p>
			<table>
				<thead>
					<tr>
	    ...
	    <p>Внимание! Магазин тестовый для оценки качества работы! Товар не продается!</p>
		</body>
	</html>';
    ...
    <html>
        ...
        <body>
            <p>Внимание! Магазин тестовый для оценки качества работы! Товар не продается! Поступила заявка от клиента на приобретение комплектующих для снаряжения патронов:</p>
            <h2>Заказ</h2>
            <table>
                <thead>
                    <tr>
